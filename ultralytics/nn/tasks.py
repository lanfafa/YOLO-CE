...
from .modules.block import SPPFCSPC, C3k2_ESFM, CGAFusion
from .modules.head import Detect_MultiSEAM,Detect_SEAM

from .Addmodules.C2K3RFAConv import C3k2_RFAConv
...
class BaseModel(nn.Module):
    ...
    def _apply(self, fn):
        ...
        if isinstance(m, (Detect,Detect_MultiSEAM,Detect_SEAM)):  # includes all Detect subclasses like Segment, Pose, OBB, WorldDetect
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        elif m in {Detect, WorldDetect, Segment, Pose, OBB, ImagePoolingAttn, v10Detect,Detect_MultiSEAM,Detect_SEAM}:
    ...
    if isinstance(model, nn.Module):  # PyTorch model
        ...
        for m in model.modules():
            if isinstance(m, Segment):
                ...
                return "obb"
            elif isinstance(m, (Detect, WorldDetect, v10Detect,Detect_MultiSEAM,Detect_SEAM)):
                return "detect"
